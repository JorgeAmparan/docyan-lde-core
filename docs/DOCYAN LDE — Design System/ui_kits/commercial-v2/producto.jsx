      ...
      <section className="band" data-screen-label="Producto — Cap. 3 La garantía">
        <div className="wrap">
          ...
          <div className="sec-grid2">
            {[
              { ic: "languages", h: { es: "El manual vino en otro idioma. No importa.", en: "The manual came in another language. It doesn't matter." }, p: { es: "Tu operador pregunta en español y recibe la respuesta en español — y a un toque, el fragmento original del documento, tal como vino. La fuente sigue siendo la fuente.", en: "Your operator asks in their language and gets the answer in their language — and one tap away, the original fragment of the document, exactly as it came. The source stays the source." } },
              { ic: "shield-check", h: { es: "Freno de alucinación", en: "Hallucination brake" }, p: { es: "Pedigree a span y umbrales por criticidad. Si la confianza no alcanza el umbral del dato, DOCYAN no responde con humo: te dice qué encontró y dónde seguir.", en: "Span-level pedigree and criticality thresholds. If confidence doesn't clear the data's threshold, DOCYAN doesn't answer with smoke: it tells you what it found and where to keep looking." } },
              { ic: "quote", h: { es: "La cita es el producto", en: "The citation is the product" }, p: { es: "Cada respuesta lleva su marca de cita al span exacto del original. No es una nota al pie decorativa: es el contrato de confianza de cada interacción.", en: "Every answer carries its citation mark to the exact span of the original. Not a decorative footnote: the trust contract of every interaction." } },
              { ic: "hash", h: { es: "Cadena SHA-256", en: "SHA-256 chain" }, p: { es: "Documento, análisis y respuesta quedan ligados criptográficamente. Cuando el auditor pregunte «¿de dónde salió esto?», hay una sola respuesta verificable.", en: "Document, analysis and answer are cryptographically linked. When the auditor asks “where did this come from?”, there is one verifiable answer." } },
            ].map((x, i) => (
      ...
      <section className="band" data-screen-label="Producto — Cierre">
        <div className="wrap">
          ...
          <div style={{ marginTop: 28, textAlign: "center" }}>
            <a className="vlink" onClick={() => go("como")}><Icon name="git-branch" size={14} />{t({ es: "¿Eres de TI? Mira cómo funciona por dentro", en: "In IT? See how it works inside" })}</a>
          </div>
        </div>
      </section>
    </main>
