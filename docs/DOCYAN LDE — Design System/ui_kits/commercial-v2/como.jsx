      ...
      <section className="band paper" data-screen-label="Cómo — Cierre">
        <div className="wrap">
          ...
          <div style={{ marginTop: 26, textAlign: "center" }}>
            <a className="vlink" onClick={() => go("seguridad")}><Icon name="shield" size={14} />{t({ es: "Seguridad y gobernanza en detalle", en: "Security & governance in detail" })}</a>
          </div>
        </div>
      </section>
    </main>
