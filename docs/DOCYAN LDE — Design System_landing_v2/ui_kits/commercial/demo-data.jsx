/* DOCYAN commercial kit — demo data for the 5 target verticals.
   Each vertical has 3 demo docs + a `qa` list of GROUNDED answers that span
   different intent-render types (info, steps, diagram, troubleshoot, video,
   history, alerts, compare). Every entry carries cite/doc/page/span so the
   source overlay and "Abrir PDF" land on the exact fragment that sustains it. */
