...
- `ui_kits/pwa/` — **Capa A**, the operational product (QR entry → consult view with cited answers, saved consulta → Playbook, admin dashboard).
- `ui_kits/commercial/` — **Capa B**, the public layer (landing, regional pricing, signup, account dashboard).
